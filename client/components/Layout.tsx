  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-brand-primary transition-colors duration-300">
      ...
      <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-brand-primary/10 border-t border-white/10 overflow-hidden">
        ...
        {/* Gradient Overlays */}
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-transparent to-slate-900/50"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-brand-primary/5 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute top-10 left-10 w-64 h-64 bg-gradient-to-br from-brand-secondary/5 to-transparent rounded-full blur-2xl"></div>
                  ...
                  >
                    <div className="relative">
                      <div className="w-12 h-12 bg-gradient-to-br from-brand-primary via-brand-secondary to-brand-purple rounded-2xl flex items-center justify-center shadow-2xl shadow-brand-primary/25 group-hover:shadow-brand-primary/40 transition-all duration-300">
                        ...
                        <div className="absolute -top-1 -right-1 w-4 h-4 bg-brand-success rounded-full opacity-80 animate-pulse"></div>
                      </div>
                    </div>
                    <div className="flex flex-col">
