          ...
          <div className="hidden lg:block">
            <div className="text-center space-y-8">
              <div className="flex items-center justify-center space-x-3 mb-8">
                ...
                <span className="text-3xl font-bold text-gray-900 dark:text-white">Leads</span>
              </div>
              ...
              <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
                Access your dashboard and continue growing your business with advanced B2B lead generation tools.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Enterprise-grade security with GDPR compliance</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="text-left">
                    <h3 className="font-semibold text-gray-900 dark:text-white">Always Available</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">99.9% uptime with 24/7 support</p>
                  </div>
                </div>
              </div>
            </div>
