  ...
  const values = [
    {
      ...
      description:
        "Every decision we make starts with how it benefits our customers and their success.",
    },
    {
      icon: Shield,
      title: "Trust & Security",
      description:
        "We protect customer data with enterprise-grade security and transparent practices.",
    },
    {
      icon: Zap,
      title: "Innovation",
    ...
    },
    {
      ...
      title: "Collaboration",
      description:
        "We believe diverse teams and perspectives drive the best outcomes.",
    },
  ];
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8 max-w-3xl mx-auto">
            We're on a mission to revolutionize B2B lead generation with
            advanced technology, helping sales teams discover, verify, and
            engage with qualified prospects at scale.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                To empower sales teams worldwide with the most accurate and
                comprehensive B2B data platform, enabling them to build
                meaningful connections and drive sustainable growth.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                We believe that quality data is the foundation of successful
                sales and marketing efforts. Our advanced technology ensures
                every interaction is backed by verified, up-to-date information.
              </p>
            </div>
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                To become the global standard for B2B lead generation and data
                intelligence, making high-quality prospect data accessible to
                businesses of all sizes.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300">
                We envision a world where sales teams spend less time searching
                for prospects and more time building relationships that drive
                mutual success.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-12">
            Join thousands of companies that rely on W3Leads for their lead
            generation needs
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-brand-primary/10 via-brand-secondary/10 to-brand-purple/10 dark:from-brand-primary dark:via-brand-secondary dark:to-brand-purple dark:opacity-90">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8">
            Join the W3Leads community and discover why thousands of sales teams
