...
export default function DomainFinder() {
  ...
  return (
    <Layout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-400">Contacts Found</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-400">10K+</div>
                  <div className="text-sm text-slate-400">Companies Trust Us</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  asChild
                  className="bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-slate-600 text-white hover:bg-slate-800 hover:border-slate-500 text-lg px-8 py-4 rounded-xl backdrop-blur-sm"
                >
                  Watch 2-Min Demo
                </Button>
              </div>
            ...
            <div className="relative">
              ...
              <div className="bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                <div className="bg-slate-900/80 rounded-2xl p-6 shadow-inner">
                    ...
                    <div className="flex space-x-3">
                      <div className="relative flex-1">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-slate-800/50 border-slate-600 text-white placeholder:text-slate-400 rounded-xl"
                          onKeyPress={(e) =>
                      ...
                      <Button
                        ...
                        className="bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 px-6 rounded-xl"
                      >
                        {isSearching ? (
                      ...
                      <div className="space-y-4 p-5 bg-slate-800/30 rounded-xl border border-slate-700/50">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                        ...
                        <div className="space-y-2">
                          <div className="text-xs text-slate-400 mb-2">Sample verified contacts:</div>
                        ...
                        <Button className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white text-sm">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-emerald-400 rounded-full animate-pulse opacity-60"></div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-blue-500 rounded-full animate-pulse opacity-40"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <Badge className="bg-slate-700/50 text-slate-300 border-slate-600 mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {features.map((feature, index) => (
              <Card key={index} className="group bg-slate-800/50 border-slate-700/50 hover:border-slate-600 transition-all duration-500 hover:shadow-2xl">
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-4 mb-4">
                    <div className={`w-14 h-14 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300`}>
        ...
        <section className="py-24 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card className="bg-slate-800/50 border-slate-700/30 lg:col-span-1">
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-lg flex items-center justify-center text-white font-bold">
                        {searchResults.companyName.charAt(0)}
                      </div>
                      <div>
                        <h3 className="text-white font-semibold">{searchResults.companyName}</h3>
                        <p className="text-slate-400 text-sm">{searchResults.industry}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {companyInsights.map((insight, index) => (
                        <div key={index} className="bg-slate-900/30 rounded-lg p-3">
                          ...
                          <div className="text-white font-medium text-sm">{insight.value}</div>
                        </div>
                      ))}
                    </div>
              ...
              {/* Contact Results */}
              <Card className="bg-slate-800/50 border-slate-700/30 lg:col-span-2">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-white flex items-center text-lg">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {searchResults.emails.map((contact: any, index: number) => (
                      <div
                        key={index}
                        className="group flex items-center justify-between p-4 bg-slate-900/30 rounded-xl hover:bg-slate-900/50 transition-all duration-300"
                      >
                        <div className="flex items-center space-x-4 flex-1">
                          <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg flex items-center justify-center text-white font-semibold">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {useCases.map((useCase, index) => (
              <Card key={index} className="group bg-slate-800/50 border-slate-700/30 hover:border-emerald-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10">
                <CardHeader className="text-center pb-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4 transform group-hover:scale-110 transition-transform duration-300">
                ...
                <CardContent className="text-center">
                  <div className="space-y-3">
                    <div className="text-2xl font-bold text-emerald-400">{useCase.metrics}</div>
                    <div className="text-sm text-slate-400">Used by {useCase.companies} companies</div>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="relative text-center group">
                ...
                {index < 3 && (
                  <ArrowRight className="hidden md:block absolute top-10 -right-4 w-6 h-6 text-emerald-400/60" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-slate-800/50 border-slate-700/30 hover:border-emerald-500/30 transition-all duration-500 hover:shadow-2xl">
                <CardContent className="p-8">
                  <div className="space-y-6">
                    ...
                    <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                      ...
                      <div className="text-emerald-300">{testimonial.results}</div>
                    </div>
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 bg-gradient-to-r from-slate-900 via-emerald-900/20 to-blue-900/20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12">
              <Button
                size="lg"
                asChild
                className="bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white text-lg px-10 py-6 rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-slate-600 text-white hover:bg-slate-800 hover:border-slate-500 text-lg px-10 py-6 rounded-xl backdrop-blur-sm"
              >
                Schedule Demo
              </Button>
            </div>
