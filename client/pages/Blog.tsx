...
export default function Blog() {
  ...
  const featuredPost = {
    ...
    excerpt:
      "Discover the latest strategies, tools, and best practices that are driving successful B2B lead generation campaigns in today's digital landscape.",
    content:
      "A comprehensive deep-dive into modern lead generation techniques that convert.",
    author: "Sarah Chen",
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Learn the latest techniques to improve your email deliverability and reduce bounce rates with our comprehensive verification guide.",
    ...
    },
    {
      ...
      excerpt:
        "Explore how artificial intelligence and machine learning are transforming the way sales teams identify and qualify prospects.",
    ...
    },
    {
      ...
      excerpt:
        "See how StartupXYZ used W3Leads to scale from zero to $1M in annual recurring revenue in just 18 months.",
      author: "David Kim",
    ...
    },
    {
      ...
      excerpt:
        "Master the art of email sequence creation with proven templates and strategies that drive engagement and conversions.",
      author: "Lisa Zhang",
    ...
    },
    {
      ...
      excerpt:
        "Understand the psychological factors that influence B2B purchase decisions and how to align your sales approach accordingly.",
      author: "James Wilson",
    ...
    },
    {
      ...
      excerpt:
        "Navigate the complex landscape of data privacy regulations while maintaining effective lead generation practices.",
      author: "Sarah Chen",
      authorRole: "CEO & Co-Founder",
      authorAvatar: "SC",
      date: "March 3, 2024",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to implement account-based marketing strategies that deliver measurable results and higher conversion rates.",
      author: "Michael Rodriguez",
      authorRole: "CTO",
      authorAvatar: "MR",
    ...
    },
    {
      ...
      excerpt:
        "Explore emerging trends and technologies that will shape the future of sales and lead generation in the next decade.",
      author: "Emily Johnson",
      authorRole: "VP of Engineering",
      authorAvatar: "EJ",
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8 max-w-3xl mx-auto">
            Insights, strategies, and best practices for modern B2B lead
            generation, email marketing, and sales success.
          </p>
          ...
          {searchFilteredPosts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {searchFilteredPosts.map((post) => (
                <Card
                  key={post.id}
                  className="glass-card border-gray-200 dark:border-white/20 hover:shadow-lg transition-all duration-300 group"
                >
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-brand-primary hover:text-brand-primary/80 p-0"
                      >
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-brand-primary/10 via-brand-secondary/10 to-brand-purple/10 dark:from-brand-primary dark:via-brand-secondary dark:to-brand-purple dark:opacity-90">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8">
            Get the latest B2B lead generation strategies, case studies, and
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            Start generating high-quality B2B leads today with W3Leads' advanced
            platform
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-brand-primary text-brand-primary hover:bg-brand-primary hover:text-white text-lg px-8 py-6"
            >
