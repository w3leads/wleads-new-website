...
export default function Pricing() {
  ...
  const plans = [
    ...
    {
      name: "Professional",
      description: "Ideal for growing teams that need advanced features and higher limits",
      monthlyPrice: 99,
      yearlyPrice: 79,
  ...
  const addOns = [
    ...
    },
    {
      ...
      description: "Enhanced contact data with social profiles and company insights",
  ...
  const faqs = [
    {
      ...
      answer: "You get 14 days of full access to all Professional plan features with 500 free verification credits. No credit card required to start."
    },
    {
      question: "What happens if I exceed my monthly limit?",
      answer: "Your account will pause verification services until the next billing cycle. You can purchase additional credits or upgrade your plan to continue."
    },
    {
    ...
    },
    {
      ...
      answer: "We offer a 30-day money-back guarantee for all paid plans. Contact support for a full refund within 30 days."
    },
    {
      question: "Is my data secure?",
      answer: "Yes, we're SOC 2 compliant and use enterprise-grade security measures. All data is encrypted in transit and at rest."
    },
    {
      question: "Do you offer volume discounts?",
      answer: "Yes, Enterprise customers can get custom pricing based on volume. Contact our sales team for a personalized quote."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "W3Leads Professional plan helped us increase our qualified leads by 340% while staying within budget.",
      avatar: "SJ",
      plan: "Professional"
    },
    {
      ...
      content: "The ROI from our W3Leads investment was clear within the first month. Best lead gen tool we've used.",
      avatar: "MC",
      plan: "Starter"
    },
    {
      ...
      content: "Enterprise features like white-labeling and unlimited verifications transformed our agency operations.",
      avatar: "ER",
      plan: "Enterprise"
    }
  ];
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Simple, <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">Transparent</span> Pricing
          </h1>
          ...
          <div className="flex items-center justify-center space-x-4 mb-12">
            <span className={`text-lg font-medium ${!isYearly ? 'text-brand-primary' : 'text-gray-600 dark:text-gray-400'}`}>
              Monthly
            </span>
            <Switch
              checked={isYearly}
                ...
                <CardHeader className="text-center pb-6">
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
                    ...
                    <plan.icon className={`w-8 h-8 ${
                      plan.recommended ? 'text-white' : 'text-gray-600 dark:text-gray-400'
                    }`} />
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-brand-primary font-semibold mt-2">
                      {getCredits(plan)} {typeof getCredits(plan) === 'string' ? '' : 'verifications/month'}
                    </div>
                  </div>
                </CardHeader>
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Add-ons & Extras</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Calculate Your ROI</h2>
            <p className="text-xl text-gray-700 dark:text-gray-300">
          ...
          <Card className="glass-card border-gray-200 dark:border-white/20 p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">20+ Hours</h3>
                <p className="text-gray-600 dark:text-gray-400">Saved per week on manual prospecting</p>
              </div>
              <div>
                <TrendingUp className="w-12 h-12 text-brand-success mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">340%</h3>
                <p className="text-gray-600 dark:text-gray-400">Average increase in qualified leads</p>
              </div>
              <div>
                <BarChart3 className="w-12 h-12 text-brand-purple mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">850%</h3>
                <p className="text-gray-600 dark:text-gray-400">Average ROI in first quarter</p>
              </div>
            </div>
          </Card>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-brand-primary/10 via-brand-secondary/10 to-brand-purple/10 dark:from-brand-primary dark:via-brand-secondary dark:to-brand-purple dark:opacity-90">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8">
            Large organization? Custom requirements? Our Enterprise team can create 
            a tailored solution that fits your exact needs.
          </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            Join thousands of sales teams who trust W3Leads for their lead generation needs
          </p>
          
          <Button size="lg" asChild className="bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-secondary hover:to-brand-primary text-white text-lg px-12 py-6 shadow-lg">
            <Link to="/signup">
